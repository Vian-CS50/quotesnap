...
export default function MediaUpload({
  ...
  return (
    <div className="w-full">
      ...
      {videoError && (
        <div className="mb-3 p-3 rounded-lg bg-danger/10 border border-danger/20 flex items-center gap-2 text-danger text-sm">
      ...
      {video && (
        <div className="mt-4">
          <p className="text-xs text-muted mb-2">Video walkthrough</p>
