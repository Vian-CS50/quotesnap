      ...
      <div className="relative border-4 overflow-hidden" style={{ borderColor: '#334155', backgroundColor: '#0f172a', borderRadius: '2.5rem' }}>
        ...
        <div className="p-6 pt-10 space-y-4">
          ...
          <div className="p-3 space-y-2 border" style={{ backgroundColor: 'var(--surface)', borderColor: 'var(--border)', borderRadius: '0px' }}>
            <div className="h-2 w-3/4" style={{ backgroundColor: 'rgba(var(--color-foreground-rgb), 0.1)', borderRadius: '0px' }} />
            <div className="h-2 w-1/2" style={{ backgroundColor: 'rgba(var(--color-foreground-rgb), 0.1)', borderRadius: '0px' }} />
            <div className="h-2 w-5/6" style={{ backgroundColor: 'rgba(var(--color-foreground-rgb), 0.1)', borderRadius: '0px' }} />
