...
function SelectField({
 ...
 className="w-full h-11 px-3 pr-10 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] appearance-none focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] outline-none transition-all cursor-pointer"
...
function TextField({
 ...
 className="w-full h-11 px-3 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] placeholder:text-[#D6D3D1] focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] outline-none transition-all"
 />
 </div>
);
}
...
export default function InteractiveDemo() {
 ...
 viewport={{ once: true }}
 transition={{ duration: 0.5 }}
 className="bg-white border border-[#D6D3D1] rounded-sm p-5 md:p-8"
 >
 ...
 : "bg-[#C2410C] hover:bg-[#9A3412] hover:scale-105 shadow-orange-200"
 } text-white`}
 ...
 <div
 key={i}
 className={`w-1.5 bg-[#C2410C] rounded-full animate-soundbar soundbar-${i}`}
 ...
 className="w-full h-28 p-4 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] placeholder:text-[#D6D3D1] focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] resize-none outline-none transition-all"
 />
 </div>
 ...
 className="w-full flex items-center justify-between p-3 rounded-sm border border-[#D6D3D1] hover:border-[#C2410C]/50 transition-colors text-sm group"
 >
 <span className="flex items-center gap-2 text-[#1C1917]">
 {filledFieldsCount > 0 ? (
 <Edit3 className="w-4 h-4 text-[#C2410C]" />
) : (
 <Plus className="w-4 h-4 text-[#A8A29E] group-hover:text-[#C2410C] transition-colors" />
)}
 ...
 className="w-full flex items-center justify-between p-2.5 rounded-sm border border-[#D6D3D1]/60 hover:border-[#D6D3D1] transition-colors text-sm"
 >
 <span className="text-[#A8A29E] font-medium">Advanced (optional)</span>
 {showAdvanced ? (
 <ChevronUp className="w-4 h-4 text-[#A8A29E]" />
) : (
 <ChevronDown className="w-4 h-4 text-[#A8A29E]" />
 ...
 disabled={loading}
 className="w-full h-12 rounded-sm bg-[#C2410C] hover:bg-[#9A3412] disabled:bg-gray-200 disabled:cursor-not-allowed text-white font-semibold transition-all inline-flex items-center justify-center gap-2"
 >
 {loading ? (
 <>
 ...
 {/* Media Upload */}
 <div className="w-full">
 <p className="text-xs font-medium text-[#A8A29E] mb-2">
 Add photos (optional)
 </p>
 <MediaUpload
 images={images}
 ...
 {error && (
 <div className="w-full p-4 bg-red-50 border border-red-200 rounded-sm text-red-700 text-sm">
 {error}
 </div>
)}
 ...
 return (
 <>
 <span className="text-xs font-medium text-[#C2410C] bg-orange-50 px-2 py-1 rounded">
 {won} Won
 </span>
 <span className="text-xs font-medium text-[#A8A29E] bg-[#F5F4F0] px-2 py-1 rounded">
 {pending} Pending
 </span>
 ...
 {totalValue > 0 && (
 <span className="text-xs font-medium text-[#1C1917] ml-auto">
 ...
 className="w-full flex items-center justify-between p-3 rounded-sm border border-[#D6D3D1] hover:border-[#C2410C]/50 transition-colors text-sm"
 >
 ...
 <ChevronDown
 className={`w-4 h-4 text-[#A8A29E] transition-transform ${
 ...
 <div
 key={item.id}
 className="flex flex-col gap-2 p-3 rounded-sm border border-[#D6D3D1] hover:border-[#C2410C]/50 hover:bg-orange-50 transition-colors group"
 >
 <div className="flex items-center gap-2">
 <button
 ...
 >
 <div className="flex items-center gap-2">
 <FileText className="w-3.5 h-3.5 text-[#A8A29E] flex-shrink-0" />
 ...
 {item.won && (
 <span className="text-[10px] font-bold bg-orange-50 text-[#C2410C] px-1.5 py-0.5 rounded flex items-center gap-0.5">
 <CheckCircle2 className="w-3 h-3" />
 Won
 </span>
)}
 {item.lost && (
 <span className="text-[10px] font-bold bg-muted/20 text-[#A8A29E] px-1.5 py-0.5 rounded">
 Lost
 </span>
)}
 </div>
 ...
 className="p-1.5 rounded-md text-[#A8A29E] hover:text-red-700 hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-opacity"
 title="Delete"
 >
 ...
 <span className="text-[10px] uppercase tracking-wider text-red-700 font-bold">Follow up:</span>
 ...
 : "border-[#D6D3D1] text-[#A8A29E] hover:text-[#1C1917]"
 }`}
 ...
 className="text-[10px] px-1.5 py-0.5 rounded border border-[#D6D3D1] text-[#A8A29E] hover:text-[#1C1917] transition-colors"
 >
 SMS
 </button>
 <button
 ...
 <div className="flex items-center gap-2">
 <label className="flex items-center gap-1.5 text-xs text-[#A8A29E] cursor-pointer">
 <input
 type="checkbox"
 checked={item.follow_up ?? false}
 onChange={() => toggleFollowUp(item.id)}
 className="w-3.5 h-3.5 rounded border-[#D6D3D1]"
 />
 Followed up
 </label>
 <button
 onClick={() => markWon(item.id)}
 className="text-xs text-[#C2410C] hover:text-[#C2410C]-hover font-medium"
 >
 Mark Won
 </button>
 <button
 onClick={() => markLost(item.id)}
 className="text-xs text-[#A8A29E] hover:text-red-700 font-medium"
 >
 Mark Lost
 </button>
 </div>
 ...
 className="bg-white border border-[#D6D3D1] rounded-sm overflow-hidden flex flex-col"
 >
 {!quote && !loading && (
 <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
 <div className="w-16 h-16 rounded-sm bg-orange-50 flex items-center justify-center mb-4">
 <FileTextIcon className="w-8 h-8 text-[#C2410C]/50" />
 </div>
 ...
 {quote && !isEditing && (
 <>
 <div className="p-4 md:p-6 border-b border-[#D6D3D1] flex flex-wrap items-center justify-between gap-4">
 <div>
 ...
 className="h-9 px-3 rounded-sm border border-[#D6D3D1] hover:border-[#C2410C]/50 text-[#1C1917] text-sm font-medium inline-flex items-center gap-2 transition-colors"
 title="Edit quote"
 >
 ...
 <button
 onClick={copySMS}
 className={`h-9 px-3 rounded-sm border text-sm font-medium inline-flex items-center gap-2 transition-colors ${
 copied === "sms"
 ? "border-[#C2410C] bg-orange-50 text-[#C2410C]"
 : "border-[#D6D3D1] hover:border-[#C2410C]/50 text-[#1C1917]"
 }`}
 ...
 onClick={downloadPDF}
 disabled={pdfLoading}
 className="h-9 px-3 rounded-sm bg-[#C2410C] hover:bg-[#9A3412] disabled:bg-gray-200 text-white text-sm font-medium inline-flex items-center gap-2 transition-colors"
 >
 {pdfLoading ? (
 ...
 <button
 onClick={printQuote}
 className="h-9 px-3 rounded-sm border border-[#D6D3D1] hover:border-gray-300 text-[#1C1917] text-sm font-medium inline-flex items-center gap-2 transition-colors"
 title="Print"
 >
 ...
 className={`w-full h-9 rounded-sm border text-sm font-medium inline-flex items-center justify-center gap-2 transition-colors ${
 copied === "mate"
 ? "border-[#C2410C] bg-orange-50 text-[#C2410C]"
 : "border-[#D6D3D1] hover:border-[#C2410C]/50 text-[#A8A29E] hover:text-[#1C1917]"
 }`}
 >
 {copied === "mate" ? (
 <CheckCircle2 className="w-4 h-4" />
 ...
 <div className="p-4 md:p-6 border-b border-[#D6D3D1] bg-[#F5F4F0]/50">
 <p className="text-xs font-medium uppercase tracking-wider text-[#A8A29E] mb-2">
 What we heard
 </p>
 <p className="text-sm text-[#1C1917]/80 italic">
 ...
 <div className="p-4 md:p-6 border-b border-[#D6D3D1]">
 <p className="text-xs font-medium uppercase tracking-wider text-[#C2410C] mb-3">
 Site Photos
 </p>
 ...
 className="w-full h-24 object-cover rounded-sm border border-[#D6D3D1]"
 />
))}
 </div>
 </div>
 ...
 <div
 className="border border-[#D6D3D1] rounded-sm overflow-hidden bg-white"
 style={{ height: "600px" }}
 >
 <iframe
 ...
 className="h-9 px-4 rounded-sm border border-[#D6D3D1] hover:border-gray-300 text-[#1C1917] text-sm font-medium transition-colors"
 >
 Cancel
 </button>
 <button
 onClick={saveEdits}
 disabled={editSaving}
 className="h-9 px-4 rounded-sm bg-[#C2410C] hover:bg-[#9A3412] disabled:bg-gray-200 text-white text-sm font-medium inline-flex items-center gap-2 transition-colors"
 >
 {editSaving ? (
 <span className="w-3.5 h-3.5 border-2 border-background/30 border-t-background rounded-full animate-spin" />
) : (
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 <div>
 <label className="block text-xs font-medium text-[#A8A29E] mb-1.5">Business Name</label>
 <input
 type="text"
 ...
 className="w-full h-10 px-3 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] outline-none"
 />
 </div>
 <div>
 <label className="block text-xs font-medium text-[#A8A29E] mb-1.5">Client Name</label>
 <input
 type="text"
 ...
 <label className="block text-xs font-medium text-[#A8A29E] mb-1.5">Job Address</label>
 <input
 type="text"
 ...
 <h4 className="text-sm font-semibold text-[#1C1917]">Line Items</h4>
 <button
 onClick={addLineItem}
 className="h-8 px-3 rounded-sm border border-[#D6D3D1] hover:border-[#C2410C]/50 text-[#1C1917] text-xs font-medium inline-flex items-center gap-1.5 transition-colors"
 >
 ...
 <div key={idx} className="p-3 rounded-sm border border-[#D6D3D1] bg-[#F5F4F0]/50 space-y-2">
 ...
 rows={2}
 className="flex-1 p-2.5 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] placeholder:text-[#D6D3D1] focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] resize-none outline-none"
 />
 <button
 onClick={() => deleteLineItem(idx)}
 className="p-2 rounded-sm text-[#A8A29E] hover:text-red-700 hover:bg-red-50 transition-colors"
 title="Delete"
 >
 ...
 <div>
 <label className="block text-[10px] uppercase tracking-wider text-[#A8A29E] mb-1">Qty</label>
 <input
 type="number"
 step="0.01"
 value={item.quantity}
 onChange={(e) => updateLineItem(idx, "quantity", e.target.value)}
 className="w-full h-9 px-2 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] outline-none"
 />
 </div>
 <div>
 <label className="block text-[10px] uppercase tracking-wider text-[#A8A29E] mb-1">Unit</label>
 <select
 value={item.unit}
 onChange={(e) => updateLineItem(idx, "unit", e.target.value)}
 className="w-full h-9 px-2 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] appearance-none focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] outline-none"
 >
 ...
 <div>
 <label className="block text-[10px] uppercase tracking-wider text-[#A8A29E] mb-1">Total</label>
 <div className="h-9 px-2 flex items-center rounded-sm bg-[#F5F4F0] text-sm font-medium text-[#1C1917]">
 ...
 {/* Totals */}
 <div className="p-4 rounded-sm border border-[#D6D3D1] bg-[#F5F4F0]/50 space-y-2">
 <div className="flex justify-between text-sm">
 <span className="text-[#A8A29E]">Subtotal</span>
 <span className="text-[#1C1917] font-medium">${Number(editedData.subtotal || 0).toFixed(2)}</span>
 </div>
 <div className="flex justify-between text-sm">
 <span className="text-[#A8A29E]">GST (10%)</span>
 <span className="text-[#1C1917] font-medium">${Number(editedData.gst || 0).toFixed(2)}</span>
 </div>
 <div className="flex justify-between text-base pt-2 border-t border-[#D6D3D1]">
 <span className="font-bold text-[#1C1917]">Total</span>
 <span className="font-bold text-[#C2410C]">${Number(editedData.total || 0).toFixed(2)}</span>
 </div>
 </div>
 ...
 <div>
 <label className="block text-xs font-medium text-[#A8A29E] mb-1.5">Notes</label>
 <textarea
 value={editedData.notes || ""}
 onChange={(e) => setEditedData({ ...editedData, notes: e.target.value })}
 rows={3}
 className="w-full p-3 bg-[#F5F4F0] border border-[#D6D3D1] rounded-sm text-sm text-[#1C1917] focus:ring-2 focus:ring-[#C2410C] focus:border-[#C2410C] resize-none outline-none"
 />
 </div>
 <div>
 <label className="block text-xs font-medium text-[#A8A29E] mb-1.5">Terms</label>
 <textarea
 ...
 transition={{ duration: 0.2 }}
 className="bg-white border border-[#D6D3D1] rounded-sm p-6 md:p-8 max-w-md w-full relative"
 ...
 className="w-full h-11 rounded-sm bg-[#C2410C] hover:bg-[#9A3412] disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold transition-all inline-flex items-center justify-center gap-2"
 >
