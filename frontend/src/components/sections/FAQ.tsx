...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Your quote history stays in your browser (localStorage) unless you export it. Voice transcripts are sent to Moonshot AI for processing. We do not sell your data. See our Privacy Policy for full details.",
  },
];
