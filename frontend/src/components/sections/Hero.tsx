...
export default function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden" style={{ backgroundColor: 'var(--background)' }}>
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span style={{ color: 'var(--primary)' }}>Win jobs in your sleep.</span>
          </motion.h1>
          ...
          >
            Talk for 30 seconds. QuoteSnap drafts a professional PDF quote from your voice memo — then reminds you to follow up so you stop losing jobs to forgetfulness.
          </motion.p>
